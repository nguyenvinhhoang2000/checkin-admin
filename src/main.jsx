            ...
            theme={{
                ...
                components: {
                    ...
                    Pagination: {
                        ...
                        borderRadius:
                            fullConfig.theme.borderRadius.circleNumber,
                        itemActiveBg: fullConfig.theme.colors.secondary[1],
                        colorPrimaryHover: fullConfig.theme.colors.primary[4],
                    },
                    Table: {
                        cellPaddingInline:
                            fullConfig.theme.antdTable.cellPaddingInline,
                        cellPaddingBlock:
                            fullConfig.theme.antdTable.cellPaddingBlock,
                        headerSplitColor:
                            fullConfig.theme.antdTable.headerSplitColor,
                    },
                    Dropdown: {
                        controlItemBgHover: fullConfig.theme.colors.primary[2],
                        paddingXXS: fullConfig.theme.padding.dropdownOverlay,
                        borderRadiusSM:
                            fullConfig.theme.borderRadius.dropdownOverlay,
                    },
                    Menu: {
